...
if __name__=="__main__":
    ...
    if args.plot:
        ...
        '''
python evaluation/teju_plot_traj.py evaluation/Ground_truth/EuRoC_left_cam/V102_GT.txt teju_FrameTrajectory_TUMFormat_stereoi.txt --plot teju_euroc_cam_stereoi.pdf

python evaluation/teju_plot_traj.py evaluation/Ground_truth/EuRoC_left_cam/V102_GT.txt teju_KeyFrameTrajectory_TUMFormat_stereoi.txt --plot teju_euroc_key_stereoi.pdf
